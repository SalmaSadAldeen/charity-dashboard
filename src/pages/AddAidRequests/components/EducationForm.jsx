  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          <label className="block text-xs font-black text-slate-700 mb-1">
            {t("academic_achievement")}
          </label>
          <select
            value={form.academicAchievement || ""}
            onChange={(e) =>
              setForm({ ...form, academicAchievement: e.target.value })
            }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="block text-xs font-black text-slate-700 mb-1">
            {t("institution_name_ar")}
          </label>
          <input
            type="text"
            value={form.institutionNameAr || ""}
            onChange={(e) =>
              setForm({ ...form, institutionNameAr: e.target.value })
            }
            className="w-full p-3 rounded-2xl border border-slate-200 bg-slate-50 focus:bg-white text-sm font-bold"
            required
          />
        ...
        <div>
          <label className="block text-xs font-black text-slate-700 mb-1">
            {t("institution_name_en")}
          </label>
          <input
            type="text"
            value={form.institutionNameEn || ""}
            onChange={(e) =>
              setForm({ ...form, institutionNameEn: e.target.value })
            }
            className="w-full p-3 rounded-2xl border border-slate-200 bg-slate-50 focus:bg-white text-sm font-bold"
            required
          />
